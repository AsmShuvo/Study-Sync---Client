...
const Footer = () => {
  return (
    <footer className="w-full bg-[#140D0d] mt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
          ...
          <div className="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
            <h4 className="text-lg text-red font-bold mb-9">Get In Touch</h4>
            <ul className="text-red transition-all duration-500 grid gap-6">
          ...
          <div className="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
            <h4 className="text-lg text-red font-bold mb-9 text-center xl:text-left">
              Quick Links
            </h4>
          ...
          <div className="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
            ...
            <div className="grid gap-7 ">
              ...
              <button
                type="submit"
                className="flex gap-2 justify-center items-center py-3.5 px-7 rounded-full text-white bg-red shadow-md w-fit transition-all duration-500 mx-auto xl:mx-0 hover:bg-indigo-700"
              >
                Subscribe
                <svg
                  width="17"
